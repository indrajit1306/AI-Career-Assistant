...
import { UserPlus, Sparkles, ArrowRight, Eye, EyeOff } from 'lucide-react';
...
export const Register: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-bg-base flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10" id="register-container" style={{ opacity: 0 }}>
        <div className="flex flex-col items-center mb-8">
          ...
          <Heading level={2} className="text-center mb-2">Create an Account</Heading>
          <p className="text-text-secondary text-center">Join AI Career Assistant today.</p>
        </div>
        ...
        <GlassCard padding="lg" className="border border-border-base/50 shadow-xl">
          ...
          <div className="mt-6 text-center text-sm text-text-secondary border-t border-border-base pt-6">
            ...
            <Link to="/login" className="font-medium text-brand-400 hover:text-brand-300 inline-flex items-center gap-1 transition-colors">
